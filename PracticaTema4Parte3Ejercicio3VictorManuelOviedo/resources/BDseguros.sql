...
CREATE TABLE NIF(
	ID_NIF integer(11) NOT NULL AUTO_INCREMENT,
	NAME_NIF varchar(15) NOT NULL UNIQUE,
	PRIMARY KEY(ID_NIF)
);
...
insert into NIF(NAME_NIF) values('49963216R');
insert into NIF(NAME_NIF) values('46569898Z');
insert into NIF(NAME_NIF) values('78949598K');
insert into NIF(NAME_NIF) values('21684981Y');
insert into NIF(NAME_NIF) values('28884642T');
...
insert into SEGURO(NIF,NOMBRE,APE1,APE2,EDAD,SEXO,CASADO,HIJOS,EMBARAZADA,COBERTURA,ENFERMEDADES,FECHA_CREACION) values(1,'Carlos','Sainz','Barrameda',35,0,true,2,false,2,1,'2014-01-18 16:33:41');
insert into SEGURO(NIF,NOMBRE,APE1,APE2,EDAD,SEXO,CASADO,HIJOS,EMBARAZADA,COBERTURA,ENFERMEDADES,FECHA_CREACION) values(4,'Pepa','Grandas','Dominguez',34,1,false,0,false,5,2,'2012-04-09 08:40:00');
insert into SEGURO(NIF,NOMBRE,APE1,APE2,EDAD,SEXO,CASADO,HIJOS,EMBARAZADA,COBERTURA,ENFERMEDADES,FECHA_CREACION) values(3,'Maria','Garcia','Lozano',28,1,true,1,true,1,4,'2004-08-21 10:15:06');
insert into SEGURO(NIF,NOMBRE,APE1,APE2,EDAD,SEXO,CASADO,HIJOS,EMBARAZADA,COBERTURA,ENFERMEDADES,FECHA_CREACION) values(2,'Francisco','Romo','Auditore',70,0,false,0,false,3,3,'2006-03-30 13:44:04');
insert into SEGURO(NIF,NOMBRE,APE1,APE2,EDAD,SEXO,CASADO,HIJOS,EMBARAZADA,COBERTURA,ENFERMEDADES,FECHA_CREACION) values(5,'Marcos','Pirri','Martin',52,0,false,1,false,4,5,'2012-12-12 15:22:12');
