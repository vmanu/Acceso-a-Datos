...
public class Ejercicio15 {
	...
	///MODIFICADO MAIN DE EJERCICIO 14-->Cambiamos opcion 3
			...
			do{
				...
				switch(op){
					...
					case 2:
						...
						break;
					case 3:
						System.out.println(new GestionProveedor().mostrarBusquedaProveedor(
								num(1,999999999,"Introduce el id del proveedor","po no")));
						break;
					case 4:
