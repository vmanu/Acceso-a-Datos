...
public class Ejercicio11 {
	...
	private static final int sal=12;
		...
		do{
			...
			switch(op){
				...
				case 10:
					...
					break;
				case 11:
					libros.clonarLibro(num(1,999999999,"Introduzca el isbn del libro existente",
							"No esta dentro de rango"), num(1,999999999,"Introduzca el nuevo isbn",
							"No esta dentro de rango"));
					break;
				case sal:
